...
- ⏱ **番茄钟**：工作 / 短休 / 长休阶段，气泡提示
- ☑️ **待办清单**：支持收件箱、今天 / 稍后分类、上午 / 下午 / 晚上轻量时间块、每日收尾归位、明日 1+2 轻计划、今日启动接力、久留任务归档、本地标题搜索、轻量编辑与下一步备注、当天完成回看与撤销、今日主线与一键专注、专注过程轻反馈与结束三选一、专注后一行轻回顾与今日片段、专注中随手收集、首页轻整理与一小段轻启动、优先级、每日 / 每周重复与一键专注
